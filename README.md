...
This was an early architecture-focused project used to learn microservices fundamentals (service discovery, gateway routing, and inter-service auth) before building [EventSphere](https://github.com/Dar-shit/eventsphere-backend), a more complete full-stack, production-deployed booking platform.
